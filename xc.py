# - Tool  :  X-Compiler
# - Author  :  Abood ~
# - Github  :  https://github.com/iiAboooodii
...
logo='''
'''+cyan  +''' __   __      _____                      _ _           
'''+blue  +''' \ \ / /     / ____|                    (_) |          
'''+cyan  +'''  \ V /_____| |     ___  _ __ ___  _ __  _| | ___ _ __ 
'''+blue  +'''   > <______| |    / _ \| '_ ` _ \| '_ \| | |/ _ \ '__|
'''+cyan  +'''  / . \     | |___| (_) | | | | | | |_) | | |  __/ |   
'''+blue  +''' /_/ \_\     \_____\___/|_| |_| |_| .__/|_|_|\___|_|   
'''+cyan  +'''                                  |_|                  
'''+yellow  +'''                                      [ By Abood ]
'''
...
def encryptsh():
    ...
    with open(".temp",'r') as temp_f, open(out_file,'w') as out_f:
        ...
        out_f.write("# - Encrypted By Abood ..\n# - Telegram https://t.me/i8iii0 ..\n\n"+filedata)
    os.remove(".temp")
    ...
    while True:
        if choose == "1" or choose=="01":
            ...
            if os.path.exists("/data/data/com.termux/files/home"):
                os.system('xdg-open --view https://github.com/iiAboooodii?tab=repositories')
            else:
                os.system('xdg-open https://github.com/iiAboooodii?tab=repositories')
            exit()
